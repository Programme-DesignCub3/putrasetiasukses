...
<article
    {{ $attributes->merge([
        'class' =>
            'hover:[&>div]:opacity-100 min-h-65 bg-cover transition bg-center sm:min-h-80 hover:bg-brand-red bg-blend-multiply',
    ]) }}
    {{ $attributes }}>
    <div
        class="min-h-65 flex items-center justify-center bg-black/35 px-5 py-10 text-center text-white opacity-0 sm:min-h-80 sm:px-8">
        <div class="max-w-sm">
