...
<article
    class="group relative flex h-full flex-col overflow-hidden rounded-xl border border-zinc-200 bg-white shadow-sm transition hover:-translate-y-1 hover:shadow-xl lg:mix-blend-multiply lg:hover:bg-black lg:hover:[&>div]:translate-y-0 lg:hover:[&>div]:py-5 lg:hover:[&>div]:opacity-100">
