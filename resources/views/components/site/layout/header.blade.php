    ...
    <div
        ...
        <div class="flex flex-col gap-3 lg:items-end">
            ...
            <div class="flex items-center justify-between gap-3">
                ...
                <div class="md:hidden" x-data="{ menuFixed: false, open: false }"
                    @keydown.escape.window="open = false"
                    x-init="window.addEventListener('scroll', () => menuFixed = window.scrollY > 150, { passive: true })"
                    :class="menuFixed ? 'fixed right-4 top-4 z-50' : 'relative'">
                    <button
                    ...
                    <div class="bg-brand-red absolute right-0 top-full z-40 mt-2 w-64 shadow-2xl shadow-black/30" id="mobile-menu"
