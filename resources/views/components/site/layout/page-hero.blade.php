...
<section class="mx-auto max-w-7xl px-0 sm:px-5 lg:px-8">
    <div class="inner-hero min-h-48 bg-cover bg-center sm:min-h-56 lg:min-h-64" style="background-image: linear-gradient(rgb(185 0 0 / 0.68), rgb(185 0 0 / 0.68)), url('{{ $image }}')" x-data="scrollReveal">
