...
@if ($site->whatsapp_number)
    <a href="https://wa.me/{{ $site->whatsapp_number }}" class="fixed bottom-4 right-4 z-30 inline-flex max-w-[calc(100vw-2rem)] items-center gap-2 rounded-full bg-green-500 px-4 py-3 text-sm font-black uppercase text-white shadow-2xl shadow-green-900/30 transition hover:bg-green-600 sm:bottom-6 sm:right-5 sm:gap-3 sm:px-5 sm:text-lg">
