<div class="list-container">
    ...
    <div class="mt-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-3" wire:loading.class="opacity-50" x-data="staggerList">
    ...
    @if ($products->hasPages())
        <div class="mt-10">
            {{ $products->onEachSide(1)->links(data: ['scrollTo' => '.list-container']) }}
        </div>
    @endif
</div>
