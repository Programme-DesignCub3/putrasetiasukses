<div>
    <div class="relative mx-auto max-w-2xl">
        <input
            ...
            autofocus
        >
        <x-lucide-search class="pointer-events-none absolute right-5 top-1/2 h-6 w-6 -translate-y-1/2 text-zinc-500" />
    </div>
    ...
    <div wire:loading.delay class="mt-12 flex items-center justify-center">
        <x-lucide-loader-circle class="h-8 w-8 animate-spin text-brand-red" />
    </div>
